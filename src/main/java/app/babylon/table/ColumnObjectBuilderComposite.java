...
import app.babylon.table.Column.Type;
...
final class ColumnObjectBuilderComposite<T> implements ColumnObject.Builder<T>
{
    ...
    ColumnObjectBuilderComposite(ColumnName columnName, Class<T> valueClass)
    {
        ...
        this.name = Objects.requireNonNull(arrayBuilder.getName());
    ...
    private ColumnObject.Builder<T> activeBuilder()
    {
        ...
        {
            return Objects.requireNonNull(this.dictionaryBuilder);
        }
        return Objects.requireNonNull(this.arrayBuilder);
    }
}

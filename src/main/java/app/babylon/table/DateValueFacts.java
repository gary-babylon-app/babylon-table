...
final class DateValueFacts
{
    ...
    static DateValueFacts from(CharSequence value)
    {
        if (value == null)
        {
            return null;
    ...
    boolean isExcelLocalDateTime()
    {
        return this.isDecimal;
    }

    String[] naturalDateSplit()
    {
        String s = this.text;

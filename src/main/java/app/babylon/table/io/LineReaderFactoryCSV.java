...
{
    @Override
    public LineReader create(DataSource dataSource, Csv.ReadSettings readSettings) throws IOException
    {
        ...
        if (readSettings instanceof Csv.ReadSettings readSettingCSV)
        {
    ...
    protected static Charset resolveCharset(Csv.ReadSettings options, DataSourceProbe probe)
    {
    ...
    protected static int resolveBomLength(Csv.ReadSettings options, DataSourceProbe probe)
    {
        if (options == null || probe == null)
        {
            return 0;

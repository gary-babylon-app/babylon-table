...
class TablePlanBuildTest
{
    ...
    void shouldApplyTransformsInInsertionOrder()
    {
        ...
        TablePlanBuild plan = new TablePlanBuild().withTransform(new TransformAfter(CODE, CODE, "/"))
    ...
    void shouldUseConfiguredOutputMetadataWhenExecutingExistingTable()
    {
        ...
        TableColumnar source = Tables.newTable(TableName.of("Source"), new TableDescription("Source description"),
                builder.build());
        TablePlanBuild plan = new TablePlanBuild().withOutputTableName(TableName.of("Built"))
    ...
    void shouldExposeConfiguredColumnTypes()
    {
        ...
        TablePlanBuild plan = new TablePlanBuild().withColumnType(AMOUNT, double.class).withColumnType(NAME,
                String.class);
    ...
    void shouldReadFromCsvDataSourceUsingPlanTypesAndTransforms()
    {
        ...
        TablePlanBuild plan = new TablePlanBuild().withOutputTableName(TableName.of("BuiltFromCsv"))
